...
- 2026-09-25: Regression (privacy grilling P3). The subsection returns with Buttondown only: Stripe out (rule 2), and the lead sentence cut to "...manage some of our engagement processes, such as newsletters." Buttondown's paragraph and link verbatim.
