...
- 2026-09-25: Regression (privacy grilling P3). The subsection returns verbatim minus the sentence "See our cookies policy for more information." (rule 3). The operator keeps the social accounts (P7).
