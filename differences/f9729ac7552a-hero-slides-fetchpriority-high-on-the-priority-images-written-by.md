...
- 2026-09-26: At the home record's finish (plan [[fd9a92bd8abd]]), the Current lines after the page re-port: the hero's priority is app/HomePage.tsx:116 (the first slide) and :142 (the carousel), the hidden next-design image's :442; app/page.tsx is the 25-line server component and holds none.
