...
<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/planning' alt="A rough sketch with a list of required beams" priority width={4250} height={2884} isInColumn />
...
<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/counting' alt="Counting and marking grid beams before cutting" width={4864} height={3648} isInColumn />
...
<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/cutting' alt="Cutting a grid beam" width={4864} height={3648} isInColumn />
...
<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/sanding' alt="Sanding the end of a grid beam" width={3946} height={2844} isInColumn />
...
<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/join' alt="Lining up two beams and threading a fastener to form a join" width={3990} height={2718} isInColumn />

<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/subcomponent' alt="Assembling a shelf component for a larger creation" width={4864} height={3648} isInColumn />
...
<StoryImage src='gridbeam.xyz/stories/building-with-grid-kit/completion' alt="A fully assembled shelf creation" width={4864} height={3648} isInColumn />
