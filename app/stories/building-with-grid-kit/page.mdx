...
export const story = {
  ...
  category: 'guide',
  url: '/building-with-grid-kit',
  image: {
    type: 'cloudinary',
    src: 'gridbeam.xyz/stories/building-with-grid-kit/counting',
    alt: 'Counting grid beams',
    width: 4864,
    height: 3648,
  },
  publishedAt: new Date('2021/08/23'),
...
<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/planning' alt="A rough sketch with a list of required beams" priority width={4250} height={2884} />

{/* > Learn more about grid units and supporting structures with tri-joins in our [basics guide](/todo). */}
...
<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/counting' alt="Counting and marking grid beams before cutting" width={4864} height={3648} />
...
<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/cutting' alt="Cutting a grid beam" width={4864} height={3648} />

> Make use of a cutting jig to help guide cuts. Otherwise, use a tape measure to mark each cut precisely.
...
<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/sanding' alt="Sanding the end of a grid beam" width={3946} height={2844} />
...
Joining different numbers of beams and panels together is possible with different combinations of our supplied nuts & bolts. {/*<!-- Learn more about which nuts & bolts to use in our [fastener guide](/todo). -->*/}
...
<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/join' alt="Lining up two beams and threading a fastener to form a join" width={3990} height={2718} />

<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/subcomponent' alt="Assembling a shelf component for a larger creation" width={4864} height={3648} />
...
<StoryImage type='cloudinary' src='gridbeam.xyz/stories/building-with-grid-kit/completion' alt="A fully assembled shelf creation" width={4864} height={3648} />
