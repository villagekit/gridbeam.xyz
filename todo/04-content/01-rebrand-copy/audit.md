...
| **FAQ — Other / "I have an idea for a custom design"** | `pages/faq.tsx:318-326` | **REWRITE** | New Q: "How do I author a custom design?" New A: "Designs are TypeScript files that use the open-source [grid-kit engine](https://github.com/villagekit/gridkit-legacy). See the [products repo](https://github.com/villagekit/gridkit-products) for examples, fork it, and submit a pull request to share your design." |
