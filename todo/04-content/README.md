...
| 02 | [Image hosting decision + migration](./02-image-hosting.md) | BLOCKED (audit + naming + env-var refactor done; awaiting Mikey on cloud-name / CNAME / upload-script details) |
