...
## Steps
- [ ] Inventory every copy-bearing surface in `node-modules/apps/gridkit/`:
...
- [ ] Output: `04-content/01-rebrand-copy/audit.md` (a sub-doc under this task, since the table will be long).
- [ ] Once the audit exists, individual Stream 01 page tasks can pull from it.
