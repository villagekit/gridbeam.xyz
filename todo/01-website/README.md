...
| 05 | [MDX stories / guides](./05-stories.md) | DONE |
| 06 | [Designs catalog browser](./06-designs-catalog.md) | DONE (build/types/lint clean; live canvas runtime verification deferred) |
