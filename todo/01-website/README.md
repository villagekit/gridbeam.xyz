...
| # | Task | Status |
|---|------|--------|
| 01 | [Bootstrap Next.js + Chakra v3 + tooling](./01-bootstrap-nextjs.md) | TODO |
| 02 | [Root layout, header, footer, mobile nav](./02-layout-and-nav.md) | TODO |
| 03 | [Home page](./03-home-page.md) | TODO |
...
| 09 | [Contact + subscribe pages](./09-contact-and-subscribe.md) | TODO |
| 10 | [Legal pages (privacy, cookies, etc)](./10-legal-pages.md) | TODO |
