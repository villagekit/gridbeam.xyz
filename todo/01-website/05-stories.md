...
- [ ] Port the 6 stories from `node-modules/apps/gridkit/pages/stories/*.mdx`:
...
## Notes
- Two of the six stories are newsletters tied to specific years — decide whether to keep them as historical or roll their content into evergreen pages. Suggest: keep as historical, label clearly.
